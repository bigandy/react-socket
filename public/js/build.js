...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormComponent = function (_React$Component) {
		...
		function FormComponent(props) {
			...
			_this.toggleLights = function (event) {
				var onOffState = _this.normaliseMsg(event.target.id);
				var emitState = onOffState === 0 ? 'lights off' : 'lights on';
	
				_this.socket.emit(emitState);
				_this.setState({ onOff: onOffState });
			...
			_this.state = {
				onOff: 0 };
			// set state to off/false
			_this.toggleLights = _this.toggleLights.bind(_this);
			return _this;
		}
		...
		_createClass(FormComponent, [{
			...
			value: function componentDidMount() {
				...
				this.socket.on('bg change', function (msg) {
					var onOffState = _this2.normaliseMsg(msg);
	
					_this2.setState({ onOff: onOffState });
			...
			key: 'normaliseMsg',
			value: function normaliseMsg(msg) {
				return msg === 'on' ? 1 : 0;
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'form',
					null,
					_react2.default.createElement('input', { type: 'radio', id: 'on', name: 'onOff', onChange: this.toggleLights, checked: this.state.onOff === 1 }),
					...
					_react2.default.createElement('input', { type: 'radio', id: 'off', name: 'onOff', defaultChecked: true, checked: this.state.onOff === 0, onChange: this.toggleLights }),
					_react2.default.createElement(
						'label',
						{ htmlFor: 'off' },
						_react2.default.createElement('i', null),
